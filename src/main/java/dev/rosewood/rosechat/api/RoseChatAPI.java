...
public final class RoseChatAPI {
    ...
    private final MessageDeletionHelper messageDeletionHelper;
    ...
    private RoseChatAPI() {
        ...
        this.messageDeletionHelper = NMSUtil.isPaper() ? new AdventureMessageDeletionHelper() : new BungeeMessageDeletionHelper();
    }
    ...
    public void deleteMessage(RosePlayer player, UUID uuid) {
        this.messageDeletionHelper.deleteMessage(this, player, uuid);
    }
